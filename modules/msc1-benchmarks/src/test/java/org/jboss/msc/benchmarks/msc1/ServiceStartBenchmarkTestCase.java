...
public final class ServiceStartBenchmarkTestCase extends AbstractBenchmarkTest {
    ...
    public void completeGraph() throws Exception {
        final long nanoseconds = CompleteGraph.benchmark(container, ACTIVE, service, COMPLETE_GRAPH_SERVICES_COUNT, INSTALLATION_THREADS_COUNT);
    ...
    public void linearGraph() throws Exception {
        final long nanoseconds = LinearGraph.benchmark(container, ACTIVE, service, LINEAR_GRAPH_SERVICES_COUNT, INSTALLATION_THREADS_COUNT);
    ...
    public void discreteGraph() throws Exception {
        final long nanoseconds = DiscreteGraph.benchmark(container, ACTIVE,  service,  DISCRETE_GRAPH_SERVICES_COUNT, INSTALLATION_THREADS_COUNT);
